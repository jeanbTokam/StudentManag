...
public class manageStudentsForm extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(11, 11, 11)
                                .addComponent(jDayChooser1, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
    ...
    public boolean verifText(){
        ...
        if(jTextField_FName.getText().equals("") || jTextField_LName.getText().equals("") 
           ...
           || jTextField_STD_ID.getText().equals("") || jDayChooser1 == null)
        {
            JOptionPane.showMessageDialog(null, "One Or More Empty Field");
            return false;
        }
        // choose a date higher then the current date
        else if(jDayChooser1.getDay() > 0){
...
//        }
        ...
        if(verifText()){
            ...
            String bdate = dateFormat.format(jDayChooser1.getDay());
            student std = new student();
...
on DELETE CASCADE
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            Date bdate = new SimpleDateFormat("yyyy-MM-dd").parse(model.getValueAt(rowIndex, 4).toString());
            jDayChooser1.setDay(ERROR);
